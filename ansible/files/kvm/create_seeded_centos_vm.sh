...
usage() {
    echo "Usage: create_seeded_centos_vm.sh -n <hostname> -i <ipaddress> -u <user> -p <password> -s <size>"
    echo "Example: create_seeded_centos_vm.sh -n test -i <ipaddress> -u centos -p pass123 -s 30G"
}
